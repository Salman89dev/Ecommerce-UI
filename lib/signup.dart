          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                ...
                labelText: "Name",
                prefixIcon:
                Icon(Icons.assignment_ind_outlined,color: Color.fromARGB(255, 0, 80, 112),size: 20,)
              ),
            ...
            Container(
              ...
              child: TextButton.icon(
                ...
                label: Text("Already have an account?",style: TextStyle(fontSize: 16,color: Colors.black),), icon: Icon(Icons.arrow_forward,color: Colors.red,) ),
            ),
            SizedBox(height: 30,),
            Container(
